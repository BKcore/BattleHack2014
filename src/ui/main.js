...
(function() {
  var LAYER_COUNT, MAX_WIDTH, MIN_SWIPE_DELAY, MIN_SWIPE_DISTANCE, SWIPE_INCREMENT_X, asyncLoop, barrier, createImage, debounce, initController, tweenLayersParallax, tweenToX;
  ...
  $(function() {
    ...
    _fn = function(i) {
      ...
      maybeAllDone = barrier(10, function() {
        return console.log('layer', i, 'done');
      });
